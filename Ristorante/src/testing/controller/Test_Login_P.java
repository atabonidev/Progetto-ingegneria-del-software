...
public class Test_Login_P {
    ...
    @BeforeEach
    public void setUp(){
        File file = new File("./src/testing/input_cases/case_Login_P.txt");
        try {
    ...
    void doLogin() {
        ...
        assertEquals(gestore.getUsername(), "g");
        assertEquals(gestore.getUserType(), "gestore");
        assertEquals(gestore.getPassword(), "pg");
    }
}
